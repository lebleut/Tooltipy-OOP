...
$glossary_page_id = tooltipy_get_option( 'glossary_page_id', false );

if( $glossary_page_id && is_numeric($glossary_page_id) && is_array( $add_to_popup ) && in_array( 'glossary', $add_to_popup ) ){
